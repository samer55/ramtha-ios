...
describe('ButtonGroup Component', () => {
  ...
  it('should render selectedIndex', () => {
    const component = shallow(
      <ButtonGroup
        ...
        buttons={buttons}
        selectedIndex={1}
        selectedButtonStyle={{ backgroundColor: '#800020' }}
  ...
  it('should render with button.element', () => {
    const component = shallow(
      <ButtonGroup
        ...
        innerBorderStyle={{ width: 300, color: '#800020' }}
      />
    );
  ...
  it('should render lastButtonStyle', () => {
    const component = shallow(
      <ButtonGroup theme={theme} buttons={buttons} lastBorderStyle={{ backgroundColor: '#800020' }} />
    );
    ...
    it('should apply disabled styles', () => {
      const wrapper = shallow(
        <ButtonGroup
          ...
          disabled
          selectedIndex={1}
          disabledStyle={{ backgroundColor: '#800020' }}
