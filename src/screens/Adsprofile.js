...
myuid:  props.navigation.getParam('uid',''),
  ...
  DisplayPosts = (d) => {
    ...
    firebaseApp.database().ref(`Ads`).on('value', (snapshot) => {
         ...
         snapshot.forEach((child) => {
           if (child.val().writerId===this.state.myuid) {
...
<ShowScroller cats="ads" dataset={this.state.posts} type="latest" navigation={this.props.navigation}/>
