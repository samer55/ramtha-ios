    ...
    return (
      <ThemeContext.Consumer>
        {theme => (
          ...
          <Header searchBar  style={{backgroundColor: 'white',width:width}}>
        <Input placeholder="بحث"  onChangeText={(d)=>this.searchFilterFunction(d)}/>
                </Header>
...
<ShowScroller cats="Special" dataset={this.state.posts} type="latest" navigation={navigation}/>
