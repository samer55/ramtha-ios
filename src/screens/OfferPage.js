...
alignSelf: 'center',
           ...
           >
<Text style={styles.Title}>Computer fixes hardware & Software</Text>
...
<FontAwesome name={this.state.heart?'heart':'heart-o'} size={20} style={{marginRight: 10}} color="#800020"/>
</Button>
<Button block style={{backgroundColor: '#eb144c',justifyContent: 'center',alignItems: 'center',padding: 20,alignSelf: 'flex-end',borderRadius: 10}}>
<Text style={[styles.time,{color:'#fff'}]}>Contact</Text>
</Button>
...
<Text style={[styles.type]}  numberOfLines={1}>Computer repairer /Local</Text>
<Text style={[styles.price]}  numberOfLines={1}>5$/hr</Text>
...
region={this.state.region}
               ...
               />
                  ...
                  <View style={{marginVertical: 3,flexDirection: 'column',paddingVertical: 10,flex:1,paddingHorizontal:10}}>
                        <Text style={[gStyle.text[theme], gStyle.Titleleft,{alignSelf: 'flex-start'}]}>Services by Ahmed</Text>

                  <ShowScroller navigation={this.props.navigation} dataset={[{title:'Computer fixes hardware & software',type:"Computer repairer",image:'https://i.pinimg.com/736x/b3/36/da/b336dac3457aefac34fd8aa931e9e078.jpg'},{title:'Hair dry and face makeup ',type:"Beauty services",image:'https://image.shutterstock.com/image-photo/makeup-artist-applies-#800020-lipstick-260nw-1011769984.jpg'}]} type="dfsd"/>
                  </View>
