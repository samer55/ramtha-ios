...
import { Image, StatusBar,Text,ImageBackground, View,Animated, ScrollView, Dimensions,StyleSheet,TouchableOpacity,Linking,RefreshControl } from 'react-native';
...
<Button block style={{backgroundColor: '#eb144c',justifyContent: 'center',alignItems: 'center',padding: 20,marginRight: 10,alignSelf: 'flex-end',borderRadius: 10}}>
<Text style={[styles.time,{color:'#fff'}]}>Follow</Text>
  ...
  <ScrollView   scrollEventThrottle={16}
    ...
    <Button onPress={()=>this.setState({heart:!this.state.heart})} transparent style={{padding: 7,justifyContent: 'center',alignItems: 'center',backgroundColor: 'rgba(0,0,0,0.2)',borderRadius: 100/2,paddingHorizontal: 10,marginRight: 10}}>

    <FontAwesome name={this.state.heart?'heart':'heart-o'} size={20}  color={this.state.heart?'#800020':'#fff'}/>
    </Button>
    <TouchableOpacity onPress={()=>this.props.navigation.goBack()} style={{justifyContent: 'center',alignItems: 'center',padding: 7,backgroundColor: 'rgba(0,0,0,0.2)',borderRadius: 100/2,paddingHorizontal: 10}}>
...
<Text style={[styles.time,{color:'green'}]}  numberOfLines={1}>Verfied</Text>
<View style={{flexDirection: 'row'}}>
<MaterialIcons name='business-center' size={15} style={{marginRight: 5}} color="black"/>

<Text style={[styles.time,{color:'#000000',fontFamily: 'Cairo-Regular',fontSize: 15}]}  numberOfLines={1}>Doctor</Text>
</View>
</View>
...
<Text style={[styles.type,{color:'black',fontFamily: 'raleway'}]}  numberOfLines={3}>Sunday, Monday, Tuesday, Wednesday, Thursday,Friday</Text>
</View>
<View style={{flexDirection: 'row',marginHorizontal: 10,marginVertical: 5}}>
<MaterialIcons name='access-time' size={15} style={{marginRight: 5}} color="black"/>

<Text style={[styles.type,{color:'black',textAlign: 'left',fontFamily: 'raleway'}]}  numberOfLines={1}>5:00 AM - 6:30 PM</Text>
</View>
{/**/}
</View>
<View style={[cstyles.edit,{flex:1}]}>
<View style={{flexDirection: 'row',marginHorizontal: 10,marginVertical: 5}}>
<MaterialIcons name='today' size={15} style={{marginRight: 5}} color="black"/>
<Text style={[styles.type,{color:'black',fontFamily: 'Cairo-Regular'}]}  numberOfLines={3}>Member since</Text>
</View>
<View style={{flexDirection: 'row',marginHorizontal: 10,marginVertical: 5}}>

<Text style={[styles.type,{color:'black',textAlign: 'left',fontFamily: 'raleway'}]}  numberOfLines={1}>April 19,2020</Text>
</View>
<Button block style={{backgroundColor: '#eb144c',justifyContent: 'center',alignItems: 'center',padding: 20,alignSelf: 'flex-end',borderRadius: 10,marginLeft: 10,width: '90%'}}>
<Text style={[styles.time,{color:'#fff'}]}>Follow</Text>
</Button>
</View>
    </View>
...
marginTop: 10,
          alignSelf: 'center',
                 ...
                 >
                 <Text style={gStyle.det}>Contact</Text>
          ...
          <FontAwesome name='youtube' size={15} style={{marginRight: 5}} color="#800020"/>
            ...
            <Text style={gStyle.det}>ِAbout</Text>
          ...
          <Text style={gStyle.p}><Text style={[gStyle.p,{fontFamily: 'Cairo-Regular',fontSize: 15,marginVertical: 0}]}>CEO at opentiq</Text></Text>

  <Text style={gStyle.p}><Text style={[gStyle.p,{fontFamily: 'Cairo-Regular',fontSize: 15,marginVertical: 0}]}>Marketing at opentiq</Text></Text>
              </View>
              <View style={styles.cards}>
              ...
              <View style={{flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',paddingRight: 10}}>
                    <Text style={[gStyle.text[theme], gStyle.Titleleft]}>Services</Text>
                    <Button transparent style={{justifyContent: 'center',alignItems: 'center'}}>
                        <Text style={[{color:'#eb144c'}]}>View all</Text>
                    </Button>

              </View>
              <ShowScroller  navigation={this.props.navigation} dataset={[{title:'Looking for Building workers',type:"Workers",image:'https://previews.123rf.com/images/bialasiewicz/bialasiewicz1603/bialasiewicz160300399/53106194-young-building-workers-during-road-construction-work.jpg',cat:'Full Time Job'},{title:'Looking for teacher for international school ',type:"Tutor / Teacher",image:'https://www.datingschoolmastery.com/wp-content/uploads/2019/03/Webp.net-resizeimage-864x549.jpg',cat:'Full Time Job'}]} type="dfsd"/>
              </View>
              <View style={{marginVertical: 3,flexDirection: 'column',paddingVertical: 10,flex:1}}>
              <View style={{flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',paddingRight: 10}}>
                    <Text style={[gStyle.text[theme], gStyle.Titleleft]}>Business</Text>
                    <Button transparent style={{justifyContent: 'center',alignItems: 'center'}}>
                        <Text style={[{color:'#eb144c'}]}>View all</Text>
                    </Button>

              </View>
              <ShowScroller dataset={[{name:'Alrazy pharmacy',type:"Pharmacies",image:'https://cdnimgen.royanews.tv/imageserv/Size728Q40/news/20200323/20375.JPG',price:'12JD',store:'Loolet Stores'},{name:'Heigh Gym',type:"Gyms",image:'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRb2Wri7FHrB7R2cZzJGhs9zRHmisBYFWBRCkYhfLzwdQlaPydd&usqp=CAU',store:"naseh Furniture"}]} type="local" />
              </View>
                    ...
                    <View style={{flexDirection: 'row',justifyContent: 'flex-start',alignItems: 'center',paddingHorizontal: 20}}>
                          <Text style={[gStyle.text[theme], gStyle.Titleleft]}>Posts</Text>
                    ...
                    navigation={this.props.navigation}
                            ...
                            show={false}
                            body="dsfjksdnfkjsn skjdnfkjsdnfkjsd jksdnfksjdfns fjksnfjsnfksd jsknfjsdnfjsdf sjfnjs"
                    name="samer anas"
