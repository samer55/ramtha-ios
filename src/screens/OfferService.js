...
<Textarea rowSpan={5} style={[gStyle.text[theme],{backgroundColor: '#ffffff'}]}  value={this.state.lovemsg} onChangeText={(lovemsg)=>this.setState({lovemsg})} bordered placeholder={`Enter list of services/offers you do in your business..
`} />
<Label style={{fontFamily: 'Cairo-Regular',marginVertical: 10}}>
Days Opening
</Label>
